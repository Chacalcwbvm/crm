            ...
            <div class="container">
                ...
                if (isset($_GET['id'])) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "</select><br>";
                        echo "<label for='data_atendimento'>Data Atendimento:</label>";
                        ...
                        echo "<label for='hora_atendimento'>Hora Atendimento:</label>";
                        ...
                        echo "<label for='tipo_pagamento_id'>Forma Pagamento:</label>";
